	...
	<div class="container">
			<div class="row">
			  <div class="col-sm-9" id="mydiv">
							...
							<div class="col">
								<div style="float:left; padding-right: 4%;"><img class="zooming" onclick="goToArticle('.$row['IdArticle'].')" width="140" height="120" src="article/img/agg.jpg" alt="Photo article"></div>
